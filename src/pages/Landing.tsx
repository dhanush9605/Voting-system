  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden py-20 md:py-32">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto animate-slide-up" style={{ animationDelay: '0.1s', animationFillMode: 'both' }}>
            ...
            <div className="flex justify-center">
              <Link to="/register">
                <Button variant="hero" size="xl" className="shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  Register to Vote
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="border-0 shadow-card hover:shadow-elevated transition-all duration-300 hover:-translate-y-2">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="relative rounded-3xl overflow-hidden bg-primary p-12 md:p-20 shadow-card hover:shadow-elevated transition-all duration-300 hover:-translate-y-2">
